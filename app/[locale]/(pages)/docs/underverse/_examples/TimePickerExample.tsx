...
export default function TimePickerExample() {
  ...
  const rows: PropsRow[] = [
    ...
    { property: "minuteStep", description: t("props.timePicker.minuteStep"), type: "number", default: "1" },
    { property: "secondStep", description: t("props.timePicker.secondStep"), type: "number", default: "1" },
    ...
    { property: "matchTriggerWidth", description: "Match dropdown width to trigger width", type: "boolean", default: "true" },
    ...
    { property: "min", description: "Alias for minTime (e.g., '09:00')", type: "string", default: "-" },
    { property: "max", description: "Alias for maxTime (e.g., '18:00')", type: "string", default: "-" },
