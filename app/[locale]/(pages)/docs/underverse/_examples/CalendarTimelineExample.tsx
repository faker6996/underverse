...
/>`;
  ...
  const rows: PropsRow[] = [
    ...
    { property: "onlyView", description: t("props.calendarTimeline.onlyView"), type: "'month' | 'week' | 'day' | 'sprint'", default: "—" },
    { property: "view", description: t("props.calendarTimeline.view"), type: "'month' | 'week' | 'day' | 'sprint'", default: "'month'" },
    { property: "defaultView", description: t("props.calendarTimeline.defaultView"), type: "'month' | 'week' | 'day' | 'sprint'", default: "'month'" },
    { property: "onViewChange", description: t("props.calendarTimeline.onViewChange"), type: "(view: CalendarTimelineView) => void", default: "—" },
    {
      property: "dueDateSprint",
      description: t("props.calendarTimeline.dueDateSprint"),
      type: "Record<string, { title: ReactNode; range_date: { start: Date | string | number; end: Date | string | number } }>",
      default: "—",
    },
