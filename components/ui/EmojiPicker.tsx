...
import { EMOJI_LIST } from "@/components/ui/UEditor/emojis";
...
/**
 * EmojiPicker - Standalone Messenger-style emoji picker component
 * 
 * @example
 * ```tsx
 * <EmojiPicker
...
export const EmojiPicker: React.FC<EmojiPickerProps> = ({
    ...
    return (
        <div className={cn("w-96 bg-card border border-border rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-128", className)}>
            {/* Header with Search */}
            {showSearch && (
                ...
                {search ? (
                    ...
                    filteredCategories.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center">
                            ...
                            <div className="text-sm font-medium text-muted-foreground">No emoji found</div>
