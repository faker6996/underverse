...
const Input = forwardRef<HTMLInputElement, InputProps>(({ 
  ...
  const { 
    label: _label, error: _error, description: _description, variant: _variant, 
    size: _size, leftIcon: _leftIcon, rightIcon: _rightIcon, clearable: _clearable,
    loading: _loading, success: _success, onClear: _onClear, hint: _hint, counter: _counter,
    ...restInput 
  } = rest as any;
