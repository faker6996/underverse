...
| **Hit** | `db_hit` | 0/10 | Chưa bắt đầu |
| **Jiren** | `db_jiren` | 0/10 | Chưa bắt đầu |
| **Frieza** | `db_frieza` | 0/10 | Chưa bắt đầu |
| **Gohan** | `db_gohan` | 0/10 | Chưa bắt đầu |
| **Piccolo** | `db_piccolo` | 0/10 | Chưa bắt đầu |
| **Bulma** | `db_bulma` | 0/10 | Chưa bắt đầu |
| **Future Trunks** | `db_trunks` | 0/10 | Chưa bắt đầu |
| **Android 17** | `db_android17` | 0/10 | Chưa bắt đầu |
| **Android 18** | `db_android18` | 0/10 | Chưa bắt đầu |
| **Krillin** | `db_krillin` | 0/10 | Chưa bắt đầu |
| **Master Roshi** | `db_roshi` | 0/10 | Chưa bắt đầu |
| **Zamasu** | `db_zamasu` | 0/10 | Chưa bắt đầu |
| **Whis** | `db_whis` | 0/10 | Chưa bắt đầu |
| **Shin** | `db_shin` | 0/10 | Chưa bắt đầu |
