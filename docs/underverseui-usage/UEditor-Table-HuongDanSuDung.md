...
Chỉ cột tương ứng thay đổi; đây là cơ chế resize cột riêng.
...
- Khi lưu HTML, UEditor giữ các thông tin độ rộng cột, chiều cao hàng, căn bảng, màu nền, viền, căn dọc, hướng chữ và metadata công thức.
